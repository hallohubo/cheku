//
//  HBWithdrawalDetailCtr.h
//  Demo
//
//  Created by 胡勃 on 2018/1/25.
//Copyright © 2018年 hufan. All rights reserved.
//
@class HBWithdrawalDetailModel;
#import <UIKit/UIKit.h>

@interface HBWithdrawalDetailCtr : UIViewController
- (instancetype)initWithCompanyId:(NSString *)companyId;
@end

@interface HBWithdrawalDetailModel : NSObject           //"bankAccount": "账户名称",
