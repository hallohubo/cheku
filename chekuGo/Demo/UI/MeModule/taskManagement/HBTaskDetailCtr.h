...
//
@class HBTaskDetailModel;
@class HBTaskReviewModel;
#import <UIKit/UIKit.h>

@interface HBTaskDetailCtr : UIViewController
@property (nonatomic, copy) void(^HBCancelBlock)(void);
- (instancetype)initWithString:(NSString*)str;
@end
@interface HBTaskDetailModel : NSObject
...
@property (nonatomic, strong) NSString *taskTitle;          // "电风扇"
@end

@interface HBTaskReviewModel : NSObject
@property (nonatomic, strong) NSString *completeDate;  // null,
@property (nonatomic, strong) NSString *completeDesc;  // null,
@property (nonatomic, strong) NSString *createTime;  // "2018-02-11 01:12:26",
@property (nonatomic, strong) NSString *examineCompany;  // "福建省福州市阿三公司",
